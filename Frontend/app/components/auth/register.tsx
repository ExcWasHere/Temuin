...
export default function RegisterPage() {
  ...
  const [role, setRole] = useState<"user" | "pengusaha">("user");
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if ((data.user.role || role) === "pengusaha") {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-sky-50 via-blue-50 to-purple-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Register Card with Expanding Animation */}
      <div
      ...
      >
        <div
          className="bg-white rounded-3xl shadow-2xl backdrop-blur-lg bg-opacity-95 border border-sky-100 overflow-hidden transition-all duration-1000 ease-out"
          style={{
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-sm md:text-base mt-2">
                Yuk coba TemuIn UMKM fav mu sekarang!
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-4 items-center">
                  <label
                    className={`px-4 py-2 rounded-xl cursor-pointer ${role === "user" ? "bg-sky-500 text-white" : "bg-white"}`}
                  >
                    <input
                      type="radio"
                      name="role"
                  ...
                  <label
                    className={`px-4 py-2 rounded-xl cursor-pointer ${role === "pengusaha" ? "bg-sky-500 text-white" : "bg-white"}`}
                  >
                    <input
                      type="radio"
                      name="role"
                      value="pengusaha"
                      checked={role === "pengusaha"}
                      onChange={() => setRole("pengusaha")}
                      className="hidden"
                    />
                    Pengusaha UMKM
                  </label>
            ...
            <p className="text-center mt-6 text-sm text-gray-600">
              ...
              <a
                href="/login"
                className="font-bold text-sky-600 hover:text-sky-700 hover:underline transition-all"
              >
                Masuk di sini!
              </a>
            </p>
