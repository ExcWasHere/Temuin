...
const umkmData: UMKM[] = [
  {
    ...
    isFavorite: false,
    menu: [
      { name: "Espresso", price: "Rp12.000" },
      { name: "Kopi Tubruk", price: "Rp8.000" },
      { name: "Latte", price: "Rp18.000" },
    ],
  },
  {
    id: 2,
    name: "Barbershop Jaya",
    category: "Jasa",
  ...
  },
  {
    ...
    reviews: 234,
    distance: "1.5 km",
    address: "Jl. Dinoyo No. 67, Malang",
    isOpen: true,
    description: "Bakso legendaris sejak 1985",
    phone: "0815-6789-0123",
    isFavorite: true,
    menu: [
      { name: "Bakso Komplit", price: "Rp25.000" },
      { name: "Mie Ayam Bakso", price: "Rp22.000" },
    ],
  },
  {
    id: 5,
    ...
    isOpen: true,
    description: "Oleh-oleh khas Malang terlengkap",
    phone: "0816-7890-1234",
    isFavorite: false,
    menu: [
      { name: "Keripik Tempe", price: "Rp15.000" },
      { name: "Oleh-Oleh Khas Malang", price: "Rp50.000" },
    ],
  },
  {
    id: 6,
    name: "Kedai Kopi Pagi",
    category: "Makanan & Minuman",
    image: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=400",
    rating: 4.4,
    reviews: 92,
    distance: "1.8 km",
    address: "Jl. Gajayana No. 34, Malang",
    isOpen: true,
    description: "Kopi morning brew terbaik di kota",
    phone: "0817-8901-2345",
    isFavorite: false,
    menu: [
      { name: "Cappuccino", price: "Rp15.000" },
      { name: "Americano", price: "Rp12.000" },
    ],
  },
];
            ...
            <div className="p-6">
              ...
              {detailTab === "jadwal" && (
                <div>
                  ...
                  {/* Example schedule: you can replace with dynamic data */}
