...
import { Store, Users, Star, Edit, MapPin, Phone, Clock, Plus, Eye, ChevronDown, LogOut, Settings, BarChart3 } from 'lucide-react';
...
export default function UMKMOwnerDashboard() {
  ...
  const businessData = {
    ...
    description: "Kopi lokal dengan cita rasa autentik. Kami menggunakan biji kopi pilihan dari petani lokal Malang.",
    isOpen: true,
  ...
  const stats = [
    { label: "Total Pengunjung", value: "1,543", icon: Users, color: "sky", change: "+12%" },
    { label: "Rating", value: "4.8", icon: Star, color: "yellow", change: "+0.2" },
    { label: "Total Ulasan", value: "124", icon: Star, color: "purple", change: "+8" },
    { label: "Views Minggu Ini", value: "342", icon: Eye, color: "green", change: "+23%" }
  ];
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-semibold">Dashboard Pengusaha</p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="font-semibold text-gray-700 hidden sm:block">Pemilik UMKM</span>
                <ChevronDown className="w-4 h-4 text-gray-600" />
              </button>

              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-sky-100 py-2">
                  <a href="#" className="flex items-center gap-3 px-4 py-2 hover:bg-sky-50 transition-all">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className={`w-12 h-12 bg-gradient-to-br from-${stat.color}-400 to-${stat.color}-500 rounded-xl flex items-center justify-center shadow-lg`}>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            {/* Chart Placeholder */}
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-sky-100">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Statistik Pengunjung</h3>
              <div className="h-64 bg-gradient-to-br from-sky-50 to-purple-50 rounded-xl flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Grafik pengunjung akan ditampilkan di sini</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-sky-100 overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h2 className="text-3xl font-bold text-gray-800 mb-2">{businessData.name}</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{businessData.openingHours}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xl font-bold text-gray-800">Galeri Foto</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-sky-100">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="text-center">
                  <div className="text-6xl font-bold text-gray-800 mb-2">{businessData.rating}</div>
                  <div className="flex items-center justify-center gap-1 mb-2">
                    {renderStars(5)}
                  </div>
                  <p className="text-gray-600">{businessData.totalReviews} ulasan</p>
                </div>
                <div className="space-y-2">
                  {[5, 4, 3, 2, 1].map((star) => (
                    <div key={star} className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-gray-600 w-12">{Math.floor((star / 5) * 100)}%</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Recent Reviews */}
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-sky-100">
              <h3 className="text-xl font-bold text-gray-800 mb-6">Ulasan Terbaru</h3>
              <div className="space-y-6">
